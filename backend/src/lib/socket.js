...
const userSocketMap = {};// this is a map of user id to socket id
...
io.on("connection", (socket) => {
    ...
    io.emit("getOnlineUsers", Object.keys(userSocketMap));// emit the online users to all connected clients(all users)
